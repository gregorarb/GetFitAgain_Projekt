<?php
//Gibt alle Items von picture zurück
...
//Gibt 1 Item von picture zurück (gesucht mit der ID)
function getThisPicture($ID){
  define('DOC_ROOT_PATH', $_SERVER['DOCUMENT_ROOT'].'/');
...
//Erstellt ein Item der Tabelle picture
function createPicture($name, $order, $pic, $group){
  define('DOC_ROOT_PATH', $_SERVER['DOCUMENT_ROOT'].'/');
  include_once DOC_ROOT_PATH . "/othermethods.php";
  ...
  $sql = "INSERT INTO picture(name, order, pic, group)
          VALUES ('$name', '$order', '$pic', '$group')";
...
//Updated ein Item der Tabelle picture
function updatePicture($ID ,$name, $order, $pic, $group){
  define('DOC_ROOT_PATH', $_SERVER['DOCUMENT_ROOT'].'/');
  include_once DOC_ROOT_PATH . "/othermethods.php";
  ...
  $sql = "UPDATE picture SET name='$name', order='$order', pic='$pic', group='$group' WHERE PictureID='$ID'";
...
//Löscht ein Item aus der Tabelle picture
