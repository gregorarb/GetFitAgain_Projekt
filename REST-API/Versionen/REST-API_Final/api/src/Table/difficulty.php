...
function getThisDifficulty($ID){
  ...
  $sql = "SELECT * FROM difficulty where DifficultyID = $ID";
  $result = $conn->query($sql) or die("Datenbankverbindung nicht möglich");
...
function createDifficulty($Level){
  ...
  $sql = "INSERT INTO difficulty (Level)
          VALUES ('$Level')";
...
function updateDifficulty($ID, $Level){
  define('DOC_ROOT_PATH', $_SERVER['DOCUMENT_ROOT'].'/');
  include_once DOC_ROOT_PATH . "/othermethods.php";
