<?php
//Gibt alle Items von category zurück
...
//Gibt 1 Item von category zurück (gesucht mit der ID)
function getThisCategory($ID){
  define('DOC_ROOT_PATH', $_SERVER['DOCUMENT_ROOT'].'/');
...
//Erstellt ein Item der Tabelle category
...
//Updated ein Item der Tabelle category
...
//Löscht ein Item aus der Tabelle category
