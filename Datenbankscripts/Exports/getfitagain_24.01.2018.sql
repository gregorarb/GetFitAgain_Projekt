...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 24. Jan 2018 um 01:37
...
(59, 1, 1, 1, 3, 0, 'IGNORESTRING'),
(60, 1, 1, 2, 2, 0, 'IGNORESTRING');
...
ALTER TABLE `answer`
  ...
  ADD CONSTRAINT `answer_ibfk_3` FOREIGN KEY (`FeedbackID`) REFERENCES `feedback` (`FeedbackID`);
